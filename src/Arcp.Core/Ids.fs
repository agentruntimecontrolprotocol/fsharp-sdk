...
module MessageId =
    ...
    let tryOfString (s: string) : Result<MessageId, string> =
        if System.String.IsNullOrEmpty s then Error "MessageId may not be empty"
        else Ok (MessageId s)
...
module SessionId =
    ...
    let tryOfString (s: string) : Result<SessionId, string> =
        if System.String.IsNullOrEmpty s then Error "SessionId may not be empty"
        else Ok (SessionId s)
...
module JobId =
    ...
    let tryOfString (s: string) : Result<JobId, string> =
        if System.String.IsNullOrEmpty s then Error "JobId may not be empty"
        else Ok (JobId s)
...
module ResultId =
    ...
    let tryOfString (s: string) : Result<ResultId, string> =
        if System.String.IsNullOrEmpty s then Error "ResultId may not be empty"
        else Ok (ResultId s)
