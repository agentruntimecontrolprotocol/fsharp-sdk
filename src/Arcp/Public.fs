...
module Public =
    ...
    type ICredentialProvisioner = ARCP.Runtime.ICredentialProvisioner
    type CredentialIssueContext = ARCP.Runtime.CredentialIssueContext
    type ICredentialStore = ARCP.Runtime.ICredentialStore
    type InMemoryCredentialStore = ARCP.Runtime.InMemoryCredentialStore
    ...
    type Credential = ARCP.Core.Credential
    type CredentialConstraints = ARCP.Core.CredentialConstraints
